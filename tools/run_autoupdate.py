...
def main():
    ...
    # Safe defaults: backup enabled, not dry-run, auto-generate and auto-stamp enabled, auto-delete disabled
    apply_upgrades_for_binds(app, binds, no_backup=False, dry_run=False, log_widget=None, auto_stamp=True, auto_delete=False, auto_generate=True)
