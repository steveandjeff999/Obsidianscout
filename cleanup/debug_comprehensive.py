...
This repository has been reorganized. The original `debug_comprehensive.py` has been moved
...
MODULE_NAME = 'dev_tools.debug_comprehensive'

def _run():
    try:
        mod = import_module(MODULE_NAME)
        if hasattr(mod, '__main__'):
            # Nothing to do; modules as placeholders may not expose run functions.
            pass
