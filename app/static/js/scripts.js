...
function initializeNavbar() {
    ...
    const navLinksWithLoading = document.querySelectorAll('.nav-link[href]');
    navLinksWithLoading.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            // Remove loading state after a short delay as fallback
            setTimeout(() => {
    ...
    dropdownElements.forEach(dropdown => {
        ...
        dropdown.addEventListener('show.bs.dropdown', function() {
            ...
            dropdownMenu.style.transition = 'all 0.25s ease-out';
...
// Add page unload event to remove loading states
window.addEventListener('beforeunload', () => {
    document.querySelectorAll('.nav-link.loading').forEach(link => {
